        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-200 p-8">
            <form method="POST" action="{{ route('dashboard.profile.update') }}" class="space-y-6" enctype="multipart/form-data">
                ...
                <div class="flex items-center gap-6">
                    <div>
                        <img src="{{ Auth::user()->gambar ? asset('storage/' . Auth::user()->gambar) : 'https://via.placeholder.com/100' }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ Auth::user()->username }}" disabled
                            class="w-full border border-gray-300 rounded-lg p-3 text-sm bg-gray-100 text-gray-600">
                    </div>
                ...
                <div class="pt-4 border-t border-gray-200">
                    <button type="submit"
                        class="bg-[#7A1F1F] text-white px-6 py-2 rounded-lg hover:bg-[#5A0F0F] transition font-medium hover:cursor-pointer">
                        Simpan Perubahan
                    </button>
                </div>
            </form>
