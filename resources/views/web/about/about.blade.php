        ...
        <div class="space-y-4 text-center">
            ...
            <div class="flex flex-col items-center space-y-4 mt-8">
                ...
                {{-- <div class="flex gap-4 mt-4">
                    <a href="instagram.com" class="bg-[#7A1F1F] w-10 h-10 flex items-center justify-center rounded-full">
    ...
    <section class="bg-white px-20 py-20">
        <div class="space-y-8">
            ...
            <div class="flex justify-center">
                <iframe src="https://www.google.com/maps?q=IPB%20Cilibende%20Bogor%2C%20Jawa%20Barat%2C%20ID&output=embed"
                    width="100%" height="450" class="rounded-xl shadow-lg" style="border:0;" allowfullscreen=""
