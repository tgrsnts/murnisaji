        ...
        <div class="w-full flex gap-6">
            ...
            <div class="flex-1">
                ...
                <div class="bg-white rounded-xl shadow px-6 py-4 flex justify-between items-center mb-6">
                    <h2 class="text-xl font-semibold text-[#7A1F1F]">Review</h2>

                    <a href="{{ route('customer.profile') }}"
                        class="font-semibold text-[#7A1F1F] hover:underline flex items-center gap-1">
                        👤 Agus
                    </a>
                </div>
                ...
                <div class="bg-white rounded-xl shadow p-6">
                    ...
                    <h3 class="font-semibold mb-4">My Review</h3>

                    {{-- RED BAR --}}
                    <div class="bg-[#7A1F1F] h-6 rounded mb-6"></div>

                    {{-- PRODUCT BOX --}}
                    <div class="border border-[#7A1F1F] rounded-xl p-4 mb-6">

                        <div class="flex justify-between items-center mb-4">
                            <p class="font-semibold">PRODUCT</p>
                            <p class="text-sm">1 January 2025</p>
                        </div>

                        <div class="flex items-center gap-4">
                            <img src="{{ asset('images/menu/menu1.png') }}" class="w-[70px] h-[70px] rounded object-cover">

                            <div>
                                <p class="font-semibold">Abon Sapi</p>
                                <p class="text-sm text-gray-500">Size : 75g</p>
                            </div>
                        </div>
                    ...
                    <div class="border border-[#7A1F1F] rounded-xl p-4 mb-6">
                        ...
                        <p class="text-sm text-gray-500 mb-2">Rate Product Quality</p>

                        <div class="flex gap-2 text-2xl cursor-pointer" id="stars">
                    ...
                    <div class="border border-[#7A1F1F] rounded-xl p-4 mb-6">
                        ...
                        <p class="text-sm font-semibold mb-2">Write your opinion about us</p>
                        <p class="text-xs text-gray-500 mb-3">
                            Share your opinion about your shopping experience on our application here
                        </p>

                        <textarea rows="6"
                            class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-[#7A1F1F]"
                    ...
                    <div class="flex justify-end gap-3">
                        ...
                        <div class="flex justify-end">
                            <a href="{{ route('customer.review') }}" class="bg-[#7A1F1F] text-white px-6 py-2 rounded-lg">
                                Review
                            </a>
                        </div>
                    </div>
