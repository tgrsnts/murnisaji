    ...
    <div class="mb-6 flex justify-center pt-6 px-6">
        ...
        <div class="w-full flex gap-6">
            ...
            <div class="flex-1 p-6">
                ...
                {{-- HEADER --}}
                <div class="bg-white rounded-2xl shadow-md p-4 mb-6 flex justify-between items-center">
                    <h1 class="text-lg font-semibold">Profile</h1>
                    <div class="flex items-center gap-2 text-sm text-gray-600">
                        <span class="font-medium">Agus</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" value="Agus Mutiara"
                                class="w-full mt-1 px-4 py-3 rounded-lg border bg-gray-50 focus:outline-none">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" value="0812 1234 1234"
                                class="w-full mt-1 px-4 py-3 rounded-lg border bg-gray-50 focus:outline-none">
                        </div>
                        ...
                        <div class="flex justify-end">
                            <a href="{{ route('customer.profile.edit') }}"
                                class="bg-[#7A1F1F] text-white px-6 py-2 rounded-lg">
                                Edit
                            </a>
                        </div>
                    </div>
